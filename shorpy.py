...
class Database:
    ...
    create_table_query = """CREATE TABLE redirects ( uid INT NOT NULL AUTO_INCREMENT , url VARCHAR(2048) NOT NULL , name VARCHAR(20) NOT NULL , PRIMARY KEY (uid), UNIQUE (name))"""
